...
func EncodeValsetConfirm(peggyID common.Hash, valset *peggytypes.Valset) common.Hash {
...
// submitted to Cosmos, verified, and then relayed to Ethereum
func EncodeTxBatchConfirm(peggyID common.Hash, batch *peggytypes.OutgoingTxBatch) common.Hash {
