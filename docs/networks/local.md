<!--
order: 3
title: Set Up a Local Private Network
-->

# Set Up and Run a Node in a Local Private Network

Now that the application is ready and the keyring populated, it's time to see how to locally run an Injective node. This guide will walk you through setting up a standalone network locally, if you wish to join as a validator on Mainnet or Testnet, please follow the relevant guides [here](../guides/).
...
- `config.toml`: used to configure Tendermint, learn more on [Tendermint's documentation](https://docs.tendermint.com/master/nodes/configuration.html),
