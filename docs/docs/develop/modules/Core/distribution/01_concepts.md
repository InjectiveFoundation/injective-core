...
To learn more, see the [F1 Fee Distribution paper](https://github.com/cosmos/cosmos-sdk/blob/main/docs/spec/fee_distribution/f1_fee_distr.pdf).
...
All stored historical rewards records for periods that are no longer referenced by any delegations
