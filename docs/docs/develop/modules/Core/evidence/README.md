...
`x/evidence` is an implementation of a Cosmos SDK module, per [ADR 009](https://github.com/cosmos/cosmos-sdk/blob/v0.45.11/docs/architecture/adr-009-evidence-module.md),
