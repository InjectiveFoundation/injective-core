...
:::tip
This document describes how to configure and use the keyring and its various backends for an Injective node. `injectived` should be installed prior to setting up the keyring. See [the Install `injectived` page](../../develop/tools/injectived/install) for more information.
:::
