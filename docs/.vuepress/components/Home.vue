<template lang="pug">
  div
    ...
    .h2 Getting Started
    .p__alt Read all about Injective Chain or dive straight into the code with guides.
    .features
      router-link(to="/tools/").features__item.features__item__light
        .features__item__image
          icon-rocket.features__item__image__img
        .features__item__text
          .features__item__text__h2 Use
          .features__item__text__h1 Dev Tools Guide
          .features__item__text__p Set up your tools and build on Injective.
      router-link(to="/guides/").features__item.features__item__dark
        .features__item__image
          icon-code.features__item__image__img
        .features__item__text
          .features__item__text__h2 Use
          .features__item__text__h1 Validators Guide
          .features__item__text__p Run your own node on Injective.
    .sections__wrapper
      .h2 Explore Injective Chain
      .p__alt Get familiar with Injective Chain and explore its main concepts.
      .sections
    ...
    .p__alt Check out the docs for the various parts of the Injective Chain stack.
    .stack
