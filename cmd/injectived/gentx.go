...
Example:
$ %s gentx my-key-name 1000000stake --home=/path/to/home/dir --keyring-backend=file --chain-id=test-chain-1 \
    --moniker="myvalidator" \
...
func writeSignedGenTx(clientCtx client.Context, outputDocument string, transaction sdk.Tx) error {
	...
	jsonTx, err := clientCtx.TxConfig.TxJSONEncoder()(transaction)
	if err != nil {
		return err
	}
