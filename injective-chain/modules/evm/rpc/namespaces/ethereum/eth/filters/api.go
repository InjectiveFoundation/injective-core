...
import (
	...
	streamtypes "github.com/InjectiveLabs/injective-core/injective-chain/modules/evm/rpc/stream"
...
func NewPublicAPI(logger log.Logger, clientCtx client.Context, stream *streamtypes.RPCStream, backend Backend) *PublicFilterAPI {
