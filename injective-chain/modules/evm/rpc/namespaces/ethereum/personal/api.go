...
import (
	...
	evmbackend "github.com/InjectiveLabs/injective-core/injective-chain/modules/evm/rpc/backend"
	evmtypes "github.com/InjectiveLabs/injective-core/injective-chain/modules/evm/types"
)

// PrivateAccountAPI is the personal_ prefixed set of APIs in the Web3 JSON-RPC spec.
type PrivateAccountAPI struct {
	backend    evmbackend.EVMBackend
	logger     log.Logger
...
func NewAPI(
	...
	iterator, err := hd.NewPathIterator(basePath, true)
	if err != nil {
		panic(err)
	}
...
func (api *PrivateAccountAPI) NewAccount(password string) (common.Address, error) {
	...
	api.logger.Info("Please backup your key file!", "path", os.Getenv("HOME")+"/.chaintypes/"+name) // TODO: pass the correct binary
...
// Unpair deletes a pairing between wallet and chaintypes.
