...
var (
	pattern_Query_L3DerivativeOrderBook_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"injective", "exchange", "v1beta1", "derivative", "L3OrderBook", "market_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_L3SpotOrderBook_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"injective", "exchange", "v1beta1", "spot", "L3OrderBook", "market_id"}, "", runtime.AssumeColonVerbOpt(false)))
	...
	pattern_Query_ActiveStakeGrant_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"injective", "exchange", "v1beta1", "active_stake_grant", "grantee"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_GrantAuthorization_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"injective", "exchange", "v1beta1", "grant_authorization", "granter", "grantee"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_GrantAuthorizations_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"injective", "exchange", "v1beta1", "grant_authorizations", "granter"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_MarketBalance_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"injective", "exchange", "v1beta1", "market_balance", "market_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_MarketBalances_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"injective", "exchange", "v1beta1", "market_balances"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_DenomMinNotional_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"injective", "exchange", "v1beta1", "denom_min_notional", "denom"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_DenomMinNotionals_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"injective", "exchange", "v1beta1", "denom_min_notionals"}, "", runtime.AssumeColonVerbOpt(false)))
)
