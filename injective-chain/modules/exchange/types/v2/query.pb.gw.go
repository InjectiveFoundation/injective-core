...
var (
	...
	pattern_Query_DenomDecimal_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 1, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"injective", "exchange", "v2", "denom_decimal", "denom"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_DenomDecimals_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 1, 2, 3}, []string{"injective", "exchange", "v2", "denom_decimals"}, "", runtime.AssumeColonVerbOpt(false)))
	...
	pattern_Query_PositionsInMarket_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"injective", "exchange", "v2", "positions", "market_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SubaccountPositions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"injective", "exchange", "v2", "positions", "subaccount_id"}, "", runtime.AssumeColonVerbOpt(false)))
