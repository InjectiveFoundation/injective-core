...
func (k *Keeper) GetAllAccountCampaignTradingRewardPendingPointsForPool(
	...
	appendPoints := func(points *v2.TradingRewardCampaignAccountPoints) (stop bool) {
...
func (k *Keeper) IterateAccountCampaignTradingRewardPendingPointsForPool(
	ctx sdk.Context,
	pendingPoolStartTimestamp int64,
	process func(*v2.TradingRewardCampaignAccountPoints) (stop bool),
) {
	ctx, doneFn := metrics.ReportFuncCallAndTimingSdkCtx(ctx, k.svcTags)
	defer doneFn()
...
func (k *Keeper) GetAllAccountTradingRewardPendingPointsForPool(
	ctx sdk.Context, pendingPoolStartTimestamp int64,
